...
class PerformanceChartPainter extends CustomPainter {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                _statsData.sweatRate.toStringAsFixed(2),
                style: const TextStyle(
                  color: _lime,
                  fontSize: 48,
                  fontWeight: FontWeight.w900,
          ...
          Row(
            children: [
              Container(
                ...
                child: Text(
                  'INTENSIDADE ${_statsData.intensity}',
                  style: const TextStyle(
                    color: _lime,
                    fontSize: 9,
                    fontWeight: FontWeight.w900,
              ...
              Container(
                ...
                child: Text(
                  '${_statsData.temperature.toStringAsFixed(0)}°C / ${_statsData.humidity}% UR',
                  style: const TextStyle(
                    color: _cyan,
                    fontSize: 9,
                    fontWeight: FontWeight.w900,
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: CustomPaint(
              painter: PerformanceChartPainter(
                data: _statsData.performanceData,
                lineColor: _cyan,
                dotColor: _lime,
              ),
              size: const Size(double.infinity, 120),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: List.generate(
              _statsData.performanceData.length,
              (index) => Text(
                _statsData.performanceData[index].time,
                style: const TextStyle(
                  color: _muted,
                  fontSize: 8,
                  fontWeight: FontWeight.w700,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                  _statsData.fluidLoss.toStringAsFixed(2),
                  style: const TextStyle(
                    color: _text,
                    fontSize: 24,
                    fontWeight: FontWeight.w900,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                  '${_statsData.variation.toStringAsFixed(1)}%',
                  style: TextStyle(
                    color: _statsData.variation < 0 ? _lime : _danger,
                    fontSize: 24,
                    fontWeight: FontWeight.w900,
                  ),
                ),
  ...
  Widget _buildTheoreticalBalance() {
    final isDeficit = _statsData.theoreticalBalance < 0;
        ...
        children: [
          Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                '${_statsData.theoreticalBalance} mL',
                style: const TextStyle(
                  color: _text,
                  fontSize: 20,
                  fontWeight: FontWeight.w900,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                '${_statsData.recommendedIntakeMin.toStringAsFixed(0)}-${_statsData.recommendedIntakeMax.toStringAsFixed(0)}',
                style: const TextStyle(
                  color: Colors.black,
                  fontSize: 32,
                  fontWeight: FontWeight.w900,
          ...
          _buildRecommendationItem(
            icon: Icons.schedule,
            text:
                'Fraccionar a cada ${_statsData.interval.toStringAsFixed(0)}-20 minutos durante o exercício.',
          ),
          const SizedBox(height: 12),
          _buildRecommendationItem(
            icon: Icons.local_florist,
            text:
                'Adicionar 400-600mg de Sódio por litro de água.',
          ),
        ],
      ),
    );
