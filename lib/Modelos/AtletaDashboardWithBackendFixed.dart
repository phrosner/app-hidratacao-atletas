      ...
      children: [
        Expanded(
          child: _buildMetricCard(
            ...
            detail: null,
            accent: _lime,
            progress: data.sweatRate > 0 ? (data.sweatRate / 2.0).clamp(0, 1) : 0,
          ),
        ),
            ...
            InkWell(
              onTap: () {
                if (i == 0) {
                  ...
                  Navigator.of(context).pushReplacementNamed(AppRotas.historicoAtleta);
                } else if (i == 2) {
                  Navigator.of(context).pushReplacementNamed(AppRotas.taxaMedia);
                } else if (i == 3) {
                  Navigator.of(context).pushReplacementNamed(AppRotas.perfilAtleta);
                }
              },
              child: SizedBox(
                width: 74,
